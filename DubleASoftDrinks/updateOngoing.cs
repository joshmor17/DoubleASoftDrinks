...
{
    public partial class updateOngoing : MetroForm
    {
        ...
        public updateOngoing(PendingDeliveries frm)
        {
            InitializeComponent();
            frm1 = frm;
        }
        ...
        private void updateOngoing_Load(object sender, EventArgs e)
        {
            try
            {
                lbluserid.Hide();
                ...
                cmd.Connection = con;
                cmd.CommandText = "SELECT * FROM transactionss WHERE transNO = '" + this.updateID + "' and status = 'On-Going'";
                cmd.ExecuteNonQuery();
        ...
        private void metroTile2_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                else
                {
                    ...
                    cmd.CommandText = "UPDATE transactionss set status = '" + cbostatus.Text + "' where transNO = '" + tbID.Text + "'";
                    cmd.ExecuteNonQuery();
        ...
        private void updateOngoing_FormClosing(object sender, FormClosingEventArgs e)
        {
            if (_altF4Pressed)
            {
        ...
        private void updateOngoing_KeyDown(object sender, KeyEventArgs e)
        {
